...
import 'package:groupmahjongrecord/ui/groupList/Widget/GroupCardList.dart';
import 'package:groupmahjongrecord/ui/groupList/Widget/SideMenu.dart';
...
class GroupList extends StatefulHookConsumerWidget {
  @override
...
//   File? _profileFile;
//   String _groupName = '';
//   void _handleGroupName(String n) {
//     setState(() {
//       _groupName = n;
//     });
//   }
...
//   String _groupMemo = '';
//   void _handleGroupMemo(String m) {
//     setState(() {
//       _groupMemo = m;
//     });
//   }
...
//   String _groupPass = '';
//   void _handleGroupPass(String p) {
//     setState(() {
//       _groupPass = p;
//     });
//   }
...
//             buildImageCard(group.img!, group.title!, group.groupId!),
//       ],
//     );
//   }
...
//                                   labelText: 'グループ名',
//                                 ),
//                                 onChanged: _handleGroupName,
//                               ),
//                               TextFormField(
//                                 decoration: InputDecoration(
//                                   labelText: '説明',
//                                 ),
//                                 onChanged: _handleGroupMemo,
//                               ),
//                               TextFormField(
//                                 decoration: InputDecoration(
//                                   labelText: 'パスワード',
//                                 ),
//                                 onChanged: _handleGroupPass,
//                               ),
//                               SizedBox(height: 20),
//                               OutlinedButton(
//                                   onPressed: () async {
...
//                     actions: <Widget>[
//                       TextButton(
//                         onPressed: _groupMemo.isEmpty || _groupPass.isEmpty
//                             ? null
//                             : () {
//                                 // ログイン
//                                 _createGroup();
