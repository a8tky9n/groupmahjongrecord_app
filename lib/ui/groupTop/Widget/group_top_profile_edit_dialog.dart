...
class GroupTopProfileEditDialog extends StatefulHookConsumerWidget {
  @override
  GroupTopProfileEditDialogState createState() =>
      GroupTopProfileEditDialogState();
}

class GroupTopProfileEditDialogState
    extends ConsumerState<GroupTopProfileEditDialog> {
  // プロフィール変更ダイアログ
  @override
